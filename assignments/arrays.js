...
console.log('The last car is ${inventory[lastCar].car_model} ${inventory[32].car_make} ${inventory[32].car_model}');
...
let BMWAndAudi = [];
for (let i = 0; i < inventory.length; i++){
  if (inventory[i].car_make === 'Audi'  || inventory[i].car_make === 'Audi'){
